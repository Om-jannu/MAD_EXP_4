...
class _MyListState extends State<MyList> {
  ...
  List<SubjectFaculty> subjects =[
    ...
    SubjectFaculty(sub:"DMBI",teacher:"Mrs Aruna"),
    SubjectFaculty(sub:"AIDS",teacher:"Mrs Sunantha"),
    SubjectFaculty(sub:"EH",teacher:"Mrs Jhanvi"),
    SubjectFaculty(sub:"AIML",teacher:"Prof. Uday"),
    SubjectFaculty(sub:"WT",teacher:"Prof. Tayyabali"),
  ];
